...
from openpyxl.styles import PatternFill, Font, colors, Alignment, Border, Side
...
for file_name in os.listdir(source_directory):
    ...
    if file_name.endswith('.xml'):
        ...
        print(f'Odnaleziono plik: {os.path.splitext(file_name)[0]}')
            ...
            for folder in os.listdir(destination_folder_path):
                ...
                if folder_last_name in xls_title.lower():
                    ...
                    if os.path.exists(xlsx_file_path):
                        ...
                        if saved_weight:
                            custom_weight = input(f"Naciśnij Enter, aby użyć zapisanej masy ciała {saved_weight}kg, "
                                                  f"lub wprowadź nową wartość masy ciała: ")
                        else:
                            custom_weight = input("Naciśnij Enter, aby użyć domyślnej masy ciała 70kg, "
                                                  "lub wprowadź nową wartość masy ciała: ")
...
if not file_found:
    print("Nie znaleziono pacjenta o podanym nazwisku.")
    print(r"Upewnij się że poprawnie wpisałeś nazwisko pacjenta i pacjent ma założony folder w N:\\")
